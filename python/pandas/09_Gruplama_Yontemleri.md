Title: Pandas 09 - Veri Gruplama Yöntemleri
Date: 2022-07-17 00:00
Category: Pandas
Tags: Python, Pandas, Kütüphane, Modül, Grup
...
Veri çerçevemizi incelediğimizde, **Takım (Team)** ismine göre grulama yapmanın uygun olacağını düşünüyorum. Takıma göre gruplama yaparak, Takımda bulunan Oyuncuların Ortalama, En az ya da En fazla Yaş (Age), Boy uzunluğu (Height), Kilo (Weight) ya da Yıllık 
Kazançlarını (Salary) görebiliriz.
...
[← Önceki Bölüm](pandas-08-veri-filtreleme-yontemleri.html) | [Sonraki Bölüm →](pandas-10-pivot_table-fonksiyonunun-kullanimi.html)
