Title: Flet 06 - Büyük listeler
Date: 2024-02-15 20:25
Category: Flet
Tags: Python, Flet, Kütüphane, Modül, GUI, Arabirim, Liste
...
Programı (kodu) çalıştırın ve sayfadaki tüm metin satırlarını başlangıçta yükleyip 
işlenmesinin birkaç saniye sürmediğini, kaydırmanın da yavaş ve gecikmeli olduğunu fark edin:

![scroll-column](https://flet.dev/img/docs/getting-started/scroll-column.gif)
...
![scroll-listview](https://flet.dev/img/docs/getting-started/scroll-listview.gif)

> **NOT**:
> 
> ListView yapıcısında `expand=True` kullandık. Düzgün çalışması için ListView'in belirtilen bir yüksekliği (ya da `horizontal (yataysa)` genişliği) olması gerekir. 
...
![row-wrap-as-grid](https://flet.dev/img/docs/getting-started/row-wrap-as-grid.png)
...
> 
> Büyük mesajları WebSocket kanalı aracılığıyla sıkıştırmak genellikle iyi bir fikir değildir, bu nedenle kanal yükünü kontrol etmek için aşağıda anlatılan **Toplu Güncelleme (Batch updates)** konusuna göz atın.
...
![grid-view](https://flet.dev/img/docs/getting-started/grid-view.png)
...
![sending-page-updates-in-batches](https://flet.dev/img/docs/getting-started/sending-page-updates-in-batches.png)

| Önceki Bölüm                                                 | Sonraki Bölüm                |
| ------------------------------------------------------------ | ---------------------------- |
| [<<< 05 Klavye Kısayolları](flet-05-klavye-kisayollari.html) | [07 Sürükle ve Bırak >>>](flet-07-surukle-ve-birak.html) |
