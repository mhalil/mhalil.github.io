...
![linux_flet_ui](images/python/flet/linux_flet_ui.png)
...
![flet-counter-safari](https://flet.dev/img/docs/getting-started/flet-counter-safari.png)

| Önceki Bölüm                                             | Sonraki Bölüm                                        |
| -------------------------------------------------------- | ---------------------------------------------------- |
| [<<< 01 Temel Özellikler](flet-01-temel-ozellikler.html) | [03 Python Rehberi >>>](flet-03-python-rehberi.html) |
