Title: Flet 03 - Python Rehberi
Date: 2024-02-10 22:22
Category: Flet
Tags: Python, Rehber, Flet, Kütüphane, Modül, GUI, Arabirim
...
![basic-app-structure](https://flet.dev/img/docs/getting-started/basic-app-structure.png)
...
![controls-text](https://flet.dev/img/docs/getting-started/controls-text.png)
...
![row](images/python/flet/row_1.png)
...
![row_2](images/python/flet/row_2.png)
...
![control-refs](https://flet.dev/img/docs/getting-started/control-refs.png)
...
**Flet**, kontrole bir referans tanımlamaya (kontrolü bir değişkene atamaya), bu referansı olay işleyicilerinde (fonksiyonlarda) kullanmaya ve daha sonra bir ağaç (yapısı) oluştururken referansı gerçek bir kontrole ayarlamaya izin veren `Ref` yardımcı sınıfı sağlar. Fikir [React](https://reactjs.org/docs/refs-and-the-dom.html)'tan gelmektedir.
...
![control-refs-rewritten](https://flet.dev/img/docs/getting-started/control-refs-rewritten.png)
...
| ---------------------------------- | ------------------------------------ |
| [<<< 02 Giris](flet-02-giris.html) | [04 Kullanicidan Girdi Almak >>>](flet-04-kullanicidan-girdi-almak.html) |
