Title: FreeCAD - Scripting 04 - Parça (Part) Komut Dosyası Oluşturmak
Date: 2022-02-22 00:00
Category: Scripting
Tags: FreeCAD, Python, Scripting, Komut, Parça, Part 
...
- [Topolojik veri kodlaması](freecad-05-topolojik-veri-kodlamasi)
...
Kaynak: [Part scripting](https://wiki.freecadweb.org/Part_scripting)

[← Önceki Bölüm](freecad-scripting-03-komut-dosyasi-olusturmanin-temelleri.html) | [Sonraki Bölüm →](freecad-scripting-05-topolojik-veri-kodlamasi.html)
