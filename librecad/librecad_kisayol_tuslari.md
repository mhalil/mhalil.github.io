Title: LibreCAD Kısayol Tuşları
Date: 2022-02-24 00:00
Category: LibreCAD
Tags: librecad, CAD, Kısayol
...
| Komutlar | Komut Açıklaması                |
| -------- | ------------------------------- |
| sa       | Tümünü Seç (Select All)         |
| tn       | Tüm Seçimi Kaldır (Select None) |
...
| xp, dp       | Patlat (Blok ya da benzer yapıların (örneğin <br>Dikdörtgen) her bir çizgi parçasının bağımsız olmasını sağlamak için <br>kullanılan komut)                                        |
| di, div, cut | Böl, Kes (Çember ve Dikdörtgen gibi parçaların <br>kesişen noktalardan Kırplımlası söz konusu değildir Bu Nedenle bu tür <br>yapılarda bu komutun kullanılması gerekmektedir.      |
| mp, prop     | Özellikler Penceresini Görüntüler                                                                                                                                                  |
| ma, attr     | Öznitelikler (Birden fazla seçim yaparak <br>hepsinin bir anda farklı katmana taşınması, Çizgi kalınlıklarının, <br>renklerinin,...vb değişmesi için bu komutu kullanabilirsiniz.) |

## Yakalama (Snap) Komutları

| Komutlar | Komut Açıklaması                                                                                     |
| -------- | ---------------------------------------------------------------------------------------------------- |
| os, sf   | Serbest Yakalama (Snap Free)                                                                         |
| sg       | Izgarayı Yakala (Snap Grid)                                                                          |
| se       | Uç Noktaları Yakala (Snap End)                                                                       |
| si       | Kesişim Noktalarını Yakala (Snap Intersect)                                                          |
| sc       | Merkezi Yakala (Çember, Yay,...vb) (Snap Center)                                                     |
| sm       | Orta Noktayı Yakala (Snap Midpoint)                                                                  |
| np, sn   | Nesneleri Yakala (Nesneyi oluşturan tüm çizgi, eğri,..vb) (Snap None)                                |
| sd       | Mesafeye Göre Yakala (Snap Dimension)                                                                |
| rn       | Hiçbir Şeyi Kısıtlama (Restrict None)                                                                |
| rr       | Ortogonal Olarak Kısıtla (Sadece Yatay ve Düşey doğrultuda harekete izin ver) (Restrict Rectangular) |
| rh       | Yatay Olarak Kısıtla (Sadece Yatay doğrultuda harekete izin ver) (Restrict Horizontal)               |
| rv       | Dikey Olarak Kısıtla (Sadece Dikey (Düzşey) doğrultuda harekete izin ver) (Restrict Vertical)        |
| rz       | Göreceli Sıfır Konumunu Ayarla                                                                       |

Kaynak: [LibreCAD Wiki - Komutlar Sayfası](https://wiki.librecad.org/index.php?title=Commands)
